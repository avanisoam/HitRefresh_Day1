...
var n = e(this), s = this, a = n.off("mouseenter", arguments.callee).showBalloon(t).on("mouseenter", function(e) {
i(n, e) && n.showBalloon();
}).data("balloon");
...
function d(t) {
q || (P = t, s(), b = e(P), R = 0, "nofollow" !== D.rel && (b = e("." + U).filter(function() {
var t = e.data(this, $).rel || this.rel;
return t === D.rel;
}), R = b.index(P), -1 === R && (b = b.add(P), R = b.length - 1)), z || (z = A = !0, 
p.show(), D.returnFocus && e(P).trigger("blur").one(te, function() {
e(this).focus();
}), u.css({
opacity:+D.opacity,
...
id:$,
"class":oe ? J + "IE" :""
}).hide(), u = o(ne, "Overlay").hide(), w = o(ne, "Wrapper"), m = o(ne, "Content").append(T = o(ne, "LoadedContent", "width:0; height:0; overflow:hidden"), H = o(ne, "LoadingOverlay").add(o(ne, "LoadingGraphic")), k = o(ne, "Title"), M = o(ne, "Current"), L = o(ne, "Next"), S = o(ne, "Previous"), I = o(ne, "Slideshow").on(X, a), K = o(ne, "Close")), 
...
var o = 0, n = 0, r = p.offset(), s = C.scrollTop(), l = C.scrollLeft();
C.unbind("resize." + J), p.css({
top:-9e4,
left:-9e4
}), D.fixed ? (r.top -= s, r.left -= l, p.css({
position:"fixed"
})) :(o = s, n = l, p.css({
position:"absolute"
...
if (z) {
var s, a = "none" === D.transition ? 0 :D.speed;
...
var i, h, s, d, c, f, u = b.length, w = "frameBorder", m = "allowTransparency";
if (z) {
if (d = function() {
...
e.isFunction(c) && (c = c.call(h)), r(c) && (f = new Image(), f.src = c);
} else _.hide();
D.iframe ? (s = o("iframe")[0], w in s && (s[w] = 0), m in s && (s[m] = "true"), 
s.name = J + +new Date(), D.fastIframe ? d() :e(s).one("load", d), s.src = D.href, 
D.scrolling || (s.scrolling = "no"), e(s).addClass(J + "Iframe").appendTo(T).one(ie, function() {
s.src = "//about:blank";
...
var i, n, a = N.prep;
A = !0, j = !1, P = b[R], t || s(), l(ie), l(Y, D.onLoad), D.h = D.height ? h(D.height, "y") - F - E :D.innerHeight && h(D.innerHeight, "y"), 
...
}), a(e(i))) :D.iframe ? a(" ") :D.html ? a(D.html) :r(i) ? (e(j = new Image()).addClass(J + "Photo").on("error", function() {
...
i.onWindowResize();
}, t(window).on("load resize orientationchange", this.resizeHandler), this.btnPrev.length && (this.btnPrevHandler = function(t) {
t.preventDefault(), i.prevSlide(), i.options.autorotationStopAfterClick && i.stopRotation();
}, this.btnPrev.on(this.options.event, this.btnPrevHandler)), this.btnNext.length && (this.btnNextHandler = function(t) {
t.preventDefault(), i.nextSlide(), i.options.autorotationStopAfterClick && i.stopRotation();
}, this.btnNext.on(this.options.event, this.btnNextHandler)), this.pagerLinks.length && (this.pagerLinksHandler = function(t) {
t.preventDefault(), i.numSlide(i.pagerLinks.index(t.currentTarget)), i.options.autorotationStopAfterClick && i.stopRotation();
}, this.pagerLinks.on(i.options.event, this.pagerLinksHandler)), this.btnPlay.length && (this.btnPlayHandler = function(t) {
t.preventDefault(), i.startRotation();
}, this.btnPlay.on(this.options.event, this.btnPlayHandler)), this.btnPause.length && (this.btnPauseHandler = function(t) {
t.preventDefault(), i.stopRotation();
}, this.btnPause.on(this.options.event, this.btnPauseHandler)), this.btnPlayPause.length && (this.btnPlayPauseHandler = function(t) {
t.preventDefault(), i.gallery.hasClass(i.options.autorotationActiveClass) ? i.stopRotation() :i.startRotation();
}, this.btnPlayPause.on(this.options.event, this.btnPlayPauseHandler)), this.options.useSwipe && t.fn.hammer && e && this.gallery.hammer({
...
function getHtmlWrappingContainer(t, e) {
return '<div id="popupDynamicStructure" class="rgba"><div id="mhDialogWrapper" class="newPopupOuterContainer newPopupOuterContainerRounderCorners ' + t + '"' + (e ? ' data-automations="' + e + '"' :"") + '><div id="mhDialogContent" class="cssgradients borderradius"></div></div></div>';
}
...
dataAutomations:t.dataAutomations ? t.dataAutomations :"mh_dialog_popup"
...
isDomElementExists("#popupDynamicStructure") || (s.wrapInner(getHtmlWrappingContainer(this.defaults.customClass, this.defaults.dataAutomations)), 
...
null == f ? (f = n.setTimeout(p, e.after), o.data("scheduledTooltipEvents", f)) :(n.clearTimeout(f), 
o.data("scheduledTooltipEvents", null));
}
}, r = function(n) {
null !== l && null !== i && (t.contains(i[0], n.target) || i[0] === n.target || t.contains(l[0], n.target) || l[0] === n.target || u(i, l, !1, !0));
}, s = function(n) {
var o = e.getUniqueID(n), i = t("#Tooltip_" + o);
if (i.length > 0) return i;
var l = e.getContent(n);
return i = t('<div class="mh-tooltip ' + e.additionalWrapperClass + '" id="Tooltip_' + o + '"><div>'), 
i.append(l).appendTo("body").position({
my:"center " + ("bottom" === e.position ? "top+15" :"bottom-15"),
at:"center " + e.position,
collision:"flipfit",
of:e.getElementToOpenTooltipOn(n),
using:function(n, e) {
t(this).css(n);
var o = t("<div>").addClass("mh-tooltip-arrow").addClass(e.vertical).addClass(e.horizontal), i = e.target.left - e.element.left + e.target.width / 2 + 3;
i > 0 && i < e.element.width && o.appendTo(this).css("left", i + "px");
}
}), a ? t("html").bind("touchend", r) :(i.on("mouseenter", function() {
u(n, i, !0);
...
var n = t(this);
a ? n.click(function(o) {
n !== i && null !== i && u(i, l, !1, !0);
var a = e.getUniqueID(n), r = t("#Tooltip_" + a);
r.length > 0 && r.is(":visible") ? u(n, r, !1, !0) :(u(n, null, !0, !0), o.preventDefault());
}) :(n.on("mouseenter", function() {
u(n, null, !0);
}), n.mouseleave(function() {
var o = e.getUniqueID(n);
u(n, t("#Tooltip_" + o), !1);
}));
}), this;
};
...
t.d.placeholder = !1, e.parent().parent().length > 0 && (e.before(o("<span></span>").attr("id", "simplemodal-placeholder").css({
display:"none"
...
bindEvents:function() {
var t = this;
o("." + t.o.closeClass).on("click.simplemodal", function(o) {
o.preventDefault(), t.close();
}), t.o.modal && t.o.close && t.o.overlayClose && t.d.overlay.on("click.simplemodal", function(o) {
o.preventDefault(), t.close();
}), i.on("keydown.simplemodal", function(o) {
t.o.modal && 9 === o.keyCode ? t.watchTab(o) :t.o.close && t.o.escClose && 27 === o.keyCode && (o.preventDefault(), 
t.close());
}), n.on("resize.simplemodal orientationchange.simplemodal", function() {
...
o("." + this.o.closeClass).off("click.simplemodal"), i.off("keydown.simplemodal"), 
n.off(".simplemodal"), this.d.overlay.off("click.simplemodal");
},
focus:function(e) {
var i = this, t = e && -1 !== o.inArray(e, [ "first", "last" ]) ? e :"first", n = o(":input:enabled:visible:" + t, i.d.wrap);
setTimeout(function() {
n.length > 0 ? n.trigger("focus") :i.d.wrap.trigger("focus");
}, 10);
},
...
var m = o.o.minWidth ? o.getVal(o.o.minWidth, "w") :"auto";
i = i ? o.o.autoResize && i > p ? p :m > i ? m :i :n ? n > p ? p :o.o.minWidth && "auto" !== m && m > n ? m :n :m, 
o.d.container.css({
height:e,
width:i
}), o.d.wrap.css({
...
return e && jQuery.extend(i, e), this.each(function() {
function e() {
...
var n = jQuery(this);
if (n.css("opacity") == i.selectOpacity) return !0;
...
display:"inline",
"z-index":1
}), a.addClass(i.coverClass).css({
display:"inline-block",
position:"relative",
top:i.adjustPosition.top,
left:i.adjustPosition.left,
"z-index":0,
"vertical-align":"middle",
width:"100%"
}), r.addClass(i.innerClass).css({
display:"block",
"white-space":"nowrap",
"text-align":"LTR" == languageDirection ? "left" :"right",
"background-position":("LTR" == languageDirection ? n.outerWidth() - i.backgroundPosition.ltr :i.backgroundPosition.rtl) + "px 50%"
}), l.css({
display:"inline-block",
overflow:"hidden"
}), l.css({
display:"inline-block",
overflow:"hidden"
}), n.on("change keyup", s).on("resize", t), i.useFixedCoverWidth && n.on("resize", e), 
n.each(s), i.useFixedCoverWidth && n.each(e), n.each(t), !0;
});
};
!function(e) {
"use strict";
...
r.binded && (i.find("[" + r.validateAttribute + "*=validate]").not("[type=checkbox]").not("[type=radio]").not(".datepicker").on(r.validationEventTrigger, t._onFieldEvent), 
i.find("[" + r.validateAttribute + "*=validate][type=checkbox],[class*=validate][type=radio]").on("click", t._onFieldEvent), 
i.find("[" + r.validateAttribute + "*=validate][class*=datepicker]").on(r.validationEventTrigger, {
delay:300
}, t._onFieldEvent), r.showOnePopup && (i.find("[" + r.validateAttribute + "*=validate]").on("focus", t._onFieldFocus), 
i.find("[" + r.validateAttribute + "*=validate][type=checkbox],[class*=validate][type=radio]").on("click", t._onFieldFocus))), 
r.autoPositionUpdate && e(window).on("resize", {
noAnimation:!0,
formElem:i
}, t.updatePromptsPosition), i.on("submit", t._onSubmitEvent), this;
},
detach:function() {
...
var F = a.prop("type");
if (("radio" == F || "checkbox" == F) && _.find("input[name='" + u + "']").length > 1 && (a = e(_.find("input[name='" + u + "'][type!=hidden]:first")), 
r.showArrow = !1), "password" == F) {
var k = a.next("#" + a.attr("id") + "_clear");
k.length > 0 && (a = a.next("#" + a.attr("id") + "_clear"));
}
"text" == F && _.find("input[name='" + u + "']").length > 1 && (a = e(_.find("input[name='" + u + "'][type!=hidden]:first")), 
r.showArrow = !1);
...
if (0 == n.find("input[name='" + o + "']:checked").length) return 1 == n.find("input[name='" + o + "']").length ? e.attr(i.validationNameAttributeName) ? t._textTemplate(i.allrules[a[r]].alertTextCheckboxTemplate, [ e.attr(i.validationNameAttributeName) ]) :i.allrules[a[r]].alertTextCheckbox :i.allrules[a[r]].alertTextCheckboxMultiple;
break;
...
var o = r[i + 1], l = a.attr("name"), s = e.find("input[name='" + l + "']:checked").length;
...
if (v) i = n = 0, o = -u; else {
var c = e.offset();
i = c.top, isIE && t.isRTL(e) && "CSS1Compat" !== document.compatMode ? e.each(function() {
